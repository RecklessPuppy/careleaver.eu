...
- Keep template controls resilient across browsers. Status: copy-button fallback and visible tool feedback added 2026-04-30.
...
- Consider opt-in or session-only local storage for sensitive fields. Status: saved free-text drafts and 18-24 checklist checkmarks now require explicit save/load actions as of 2026-04-30.
