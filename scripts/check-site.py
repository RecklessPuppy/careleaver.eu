...
def check_index_guardrails(errors: list[str]) -> None:
    ...
    required_snippets = [
        ...
        "Nach dem Termin kurz bestätigen",
        'id="followup-script"',
        "Diese Vorlage berechnet keine Frist",
        "Unterlagen nachreichen",
        'id="documents-followup-script"',
        "Bitte bestätigen Sie kurz den Erhalt",
        "Prüfe direkt bei der Stelle, ob Kopie, Scan oder Original nötig ist.",
